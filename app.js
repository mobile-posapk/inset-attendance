...
async function apiRequest(
  ...
  try {
    ...
    try {
      ...
      throw new Error(
        'The Google Apps Script did not return JSON.'
      );
    ...
    console.warn(
      `Fetch API failed [${action}], trying JSONP fallback:`,
      fetchError
    );

    try {

      return await apiRequestJSONP(
        action,
        data
      );
